  ...
  return (
    <aside className="w-56 shrink-0 flex flex-col h-screen bg-carbon-800 border-r border-carbon-700">
      <div className="px-5 py-6 border-b border-carbon-700">
        <h1 className="font-display text-ivory-200 text-lg tracking-wide">Palimpsesto</h1>
        <p className="text-xs text-bronze-500 font-mono mt-0.5 tracking-wider">Yuyaypata</p>
      </div>
